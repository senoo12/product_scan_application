...
class Baterai(models.Model):
    judul_baterai = models.CharField(max_length=255, default='Judul Default', blank=True)
...
class Layar(models.Model):
    judul_layar = models.CharField(max_length=255, default="Judul Default", blank=True)
...
class Casing(models.Model):
    judul_casing = models.CharField(max_length=255, default="Default Judul", blank=True)
...
class Prosesor(models.Model):
    judul_prosesor = models.CharField(max_length=255, default="Default Judul", blank=True)
...
class GPU(models.Model):
    judul_gpu = models.CharField(max_length=255, default="Default Judul", blank=True)
...
class RAM(models.Model):
    judul_ram = models.CharField(max_length=255, default="Default Judul", blank=True)
...
class Penyimpanan(models.Model):
    judul_penyimpanan = models.CharField(max_length=255, default="Default Judul", blank=True)
...
class Kamera(models.Model):
    judul_kamera = models.CharField(max_length=255,default="Judul Default", blank=True)
...
class Charger(models.Model):
    judul_charger = models.CharField(max_length=255, default="Judul Default", blank=True)
...
class Laptop(models.Model):
    judul_laptop = models.CharField(max_length=255, default="Judul Default", blank=True)
